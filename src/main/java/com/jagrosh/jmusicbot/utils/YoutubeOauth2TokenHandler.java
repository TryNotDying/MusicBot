 ...
 * Below is the youtube OAuth2 handler featuring a logback turbo filter, used retrieve the YouTube OAuth2 refresh token that gets logged once authorized with YouTube.
 */
